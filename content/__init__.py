...
Areas:
- the_grove: Central hub - Gate Plaza, Town Square, Tavern Row, etc.
...
Usage:
    from content.the_grove import build_grove, spawn_grove_npcs, build_all
...
from .the_grove import (
    GROVE_ROOMS, GROVE_NPCS, GROVE_DIALOGUE,
    build_grove, spawn_grove_npcs, build_all as build_grove_all
)
