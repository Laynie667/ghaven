...
# =============================================================================
# GENDER IDENTITY / SEX CONFIGURATION
# =============================================================================
...
GENDER_CONFIGS = {
    ...
    "male": {
        ...
        "parts": {
            "cock": {"default": "cock", "aroused": "hard cock"},
            "balls": {"default": "balls"},
        },
    },
    ...
    "female": {
        "name": "Female",
        "desc": "Standard female anatomy.",
        "has_cock": False,
        "has_balls": False,
        "has_pussy": True,
        "has_breasts": True,
        "has_womb": True,
        "default_pronouns": "she/her/her",
        "parts": {
            "pussy": {"default": "pussy", "aroused": "wet pussy"},
            "clit": {"default": "clit", "aroused": "swollen clit"},
            "breasts": {"default": "breasts", "aroused": "flushed breasts"},
            "nipples": {"default": "nipples", "aroused": "stiff nipples"},
        },
    },
    
    "futa": {
        "name": "Futanari",
        "desc": "Both sets of genitals, typically feminine presentation.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": True,
        "has_breasts": True,
    ...
    "herm": {
        "name": "Hermaphrodite",
        "desc": "True hermaphrodite with both sets.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": True,
        "has_breasts": True,
    ...
    "dickgirl": {
        "name": "Dickgirl",
        "desc": "Cock and balls, feminine body, no pussy.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": False,
        "has_breasts": True,
    ...
    "cuntboy": {
        "name": "Cuntboy",
        "desc": "Pussy but masculine presentation, no breasts.",
        "has_cock": False,
        "has_balls": False,
        "has_pussy": True,
        "has_breasts": False,
    ...
    "trap": {
        "name": "Trap/Femboy",
        "desc": "Male anatomy, very feminine presentation.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": False,
        "has_breasts": False,  # Flat or very small
        "has_womb": False,
        "default_pronouns": "he/him/his",  # Or she - player choice
        "parts": {
            "cock": {"default": "cute cock", "aroused": "hard little cock"},
            "balls": {"default": "small balls"},
        },
    },
    
    "femboy": {
        "name": "Femboy",
        "desc": "Male anatomy, feminine appearance.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": False,
        "has_breasts": False,
    ...
    "nulled": {
        "name": "Nullified/Smooth",
        "desc": "No external genitalia.",
        "has_cock": False,
        "has_balls": False,
        "has_pussy": False,
        "has_breasts": False,
        ...
        "default_pronouns": "they/them/their",
        "parts": {
            "groin": {"default": "smooth groin"},
        },
    },
    
    "doll": {
        "name": "Doll",
        "desc": "Smooth with breasts, no genitals.",
        "has_cock": False,
        "has_balls": False,
        "has_pussy": False,
        "has_breasts": True,
    ...
    "hucow": {
        "name": "Hucow",
        "desc": "Female with enhanced breasts for milking.",
        "has_cock": False,
        "has_balls": False,
        "has_pussy": True,
        "has_breasts": True,
        ...
        "default_pronouns": "she/her/her",
        "parts": {
            "pussy": {"default": "pussy", "aroused": "needy pussy"},
            "breasts": {"default": "heavy, milk-laden breasts", "aroused": "swollen breasts, nipples dripping"},
            "nipples": {"default": "thick nipples", "aroused": "leaking nipples"},
            "udder": {"default": "full udder"},
        },
    },
    
    "breeder": {
        "name": "Breeder",
        "desc": "Male optimized for breeding.",
        "has_cock": True,
        "has_balls": True,
        "has_pussy": False,
        "has_breasts": False,
        ...
        "default_pronouns": "he/him/his",
        "parts": {
            "cock": {"default": "thick breeding cock", "aroused": "throbbing breeding cock"},
            "balls": {"default": "heavy, churning balls"},
        },
    },
}


def get_gender_config(config_key):
    """Get a gender configuration by key."""
    return GENDER_CONFIGS.get(config_key.lower())


def list_gender_configs():
    """List available gender configurations."""
    return list(GENDER_CONFIGS.keys())


def apply_gender_config(character, config_key, set_pronouns=True):
    """
    Apply a gender configuration to character.
    
    Args:
        character: The character
        config_key: Key from GENDER_CONFIGS
        set_pronouns: Also set default pronouns
    ...
    # Apply config parts
    for part_name, part_data in config.get("parts", {}).items():
        parts[part_name] = dict(part_data)
    
    # Store gender config
    character.db.gender_config = config_key
    
    # Store flags for quick checking
    character.db.has_cock = config.get("has_cock", False)
    character.db.has_balls = config.get("has_balls", False)
    character.db.has_pussy = config.get("has_pussy", False)
    character.db.has_breasts = config.get("has_breasts", False)
    character.db.has_womb = config.get("has_womb", False)
    
    # Set pronouns if requested
    if set_pronouns and not character.db.pronouns:
        character.db.pronouns = config.get("default_pronouns", "they/them/their")
    
    return True


def has_cock(character):
    """Check if character has a cock."""
    return character.db.has_cock or False


def has_pussy(character):
    """Check if character has a pussy."""
    return character.db.has_pussy or False


def has_breasts(character):
    """Check if character has breasts."""
    return character.db.has_breasts or False


def has_womb(character):
    """Check if character can be impregnated."""
    return character.db.has_womb or False


def is_futa(character):
    """Check if character has both sets."""
    return has_cock(character) and has_pussy(character)
...
def process_shortcodes(character, text, location=None):
    ...
    Supported codes:
        ...
        <time.desc> - Period description
        <time.full> - Full formatted time
        <time.day> - Day of week
        <time.date> - Full date
        <weather> - Current weather name
        <weather.desc> - Weather description
        <weather.effects> - Weather effects list
        <season> - Current season
        <season.desc> - Season description
        <state.energy> - Energy level display
        <state.arousal> - Arousal level display  
        <state.condition> - Physical condition display
        <state.clean> - Cleanliness display
        <state.drunk> - Intoxication display
        <state.summary> - One-line notable states
        <if.aroused> - Conditional arousal text
        <if.tired> - Conditional tired text
        <if.hurt> - Conditional hurt text
        <if.dirty> - Conditional dirty text
        <if.drunk> - Conditional drunk text
    
    Args:
        character: The character (for body/worn codes)
        text: Text with shortcodes
        location: Optional location for weather (defaults to character.location)
    ...
    if location is None and character:
    ...
    def replace_code(match):
        ...
        if code_type == "body" and len(parts) >= 2:
            ...
            return character.key if character else "someone"
        ...
        # State shortcodes - use conditions system
        elif code_type == "state":
            try:
                from world.conditions import (
                    get_arousal, get_arousal_data, get_arousal_display,
                    get_exhaustion, get_exhaustion_data, get_exhaustion_display,
                    get_wounds, get_wound_data, get_wound_display,
                    get_state_description, get_conditions, get_condition_descriptions,
                )
                
                if len(parts) == 1 or parts[1] == "summary":
                    return get_state_description(character)
                elif parts[1] == "arousal":
                    if len(parts) > 2 and parts[2] == "desc":
                        data = get_arousal_data(character)
                        return data.get("desc", "")
                    return get_arousal_display(character)
                elif parts[1] in ("energy", "exhaustion", "stamina"):
                    if len(parts) > 2 and parts[2] == "desc":
                        data = get_exhaustion_data(character)
                        return data.get("desc", "")
                    return get_exhaustion_display(character)
                elif parts[1] in ("condition", "wounds", "health"):
                    if len(parts) > 2 and parts[2] == "desc":
                        data = get_wound_data(character)
                        return data.get("desc", "")
                    return get_wound_display(character)
                elif parts[1] == "conditions":
                    descs = get_condition_descriptions(character)
        ...
        # Conditional state shortcodes
        elif code_type == "if":
            try:
                from world.conditions import (
                    get_arousal, get_arousal_data,
                    get_exhaustion, get_exhaustion_data,
                    get_wounds, get_wound_data,
                    has_condition, get_conditions,
                )
                ...
                if condition == "aroused" and get_arousal(character) >= 2:
                    data = get_arousal_data(character)
                    result = data.get("desc", "")
                elif condition == "tired" and get_exhaustion(character) >= 2:
                    data = get_exhaustion_data(character)
                    result = data.get("desc", "")
                elif condition == "hurt" and get_wounds(character) >= 2:
                    data = get_wound_data(character)
                    result = data.get("desc", "")
                elif condition == "sweaty" and has_condition(character, "sweaty"):
                    result = "glistening with sweat"
                elif condition == "dirty" and (has_condition(character, "cum_covered") or has_condition(character, "slime_covered")):
                    from world.conditions import VISIBLE_CONDITIONS
                    for cond in get_conditions(character):
                        if cond["key"] in ("cum_covered", "slime_covered"):
                            result = VISIBLE_CONDITIONS[cond["key"]]["desc"]
                            break
                elif condition == "bound" and has_condition(character, "bound"):
                    result = "wrists bound"
                elif condition == "gagged" and has_condition(character, "gagged"):
                    result = "gagged"
                elif condition == "collared" and has_condition(character, "collared"):
                    result = "wearing a collar"
                
                # Process pronouns in result
                if result and character:
                    pronouns = character.db.pronouns or "they/them/their"
                    pparts = pronouns.split("/")
                    if len(pparts) >= 3:
                        result = result.replace("&they", pparts[0])
                        result = result.replace("&them", pparts[1])
                        result = result.replace("&their", pparts[2])
                        result = result.replace("&themselves", pparts[1] + "self" if pparts[1] != "them" else "themselves")
        ...
        # Time shortcodes
            ...
            try:
                from world.time_weather import (
                    get_period, get_period_description, get_time_string,
                    get_formatted_time, get_day_of_week, get_time
                )
                
                if len(parts) == 1 or parts[1] == "period":
                    return get_period()
                elif parts[1] == "hour":
                    return get_time_string()
                elif parts[1] == "desc":
                    return get_period_description()
                elif parts[1] == "full":
                    ...
                    gt = get_time()
                    return f"{gt['day']} {gt['month_name']}, Year {gt['year']}"
                else:
                    return get_period()
            except ImportError:
                return "day"
        ...
        # Weather shortcodes
        elif code_type == "weather":
            try:
                from world.time_weather import (
                    get_weather, get_weather_description, get_weather_effects,
                    WEATHER_CONDITIONS
                )
                ...
                if weather is None:
                    return ""  # Indoors, no weather text
                
                if len(parts) == 1:
                    weather_data = WEATHER_CONDITIONS.get(weather, {})
                    return weather_data.get("name", weather)
                elif parts[1] == "desc":
                    return get_weather_description(location, include_indoor=False)
                elif parts[1] == "effects":
                    effects = get_weather_effects(location)
        ...
        # Season shortcodes
        elif code_type == "season":
            try:
                from world.time_weather import get_season, get_season_description
                
                if len(parts) == 1:
                    return get_season()
                elif parts[1] == "desc":
                    return get_season_description()
                else:
                    return get_season()
            except ImportError:
                return "summer"
